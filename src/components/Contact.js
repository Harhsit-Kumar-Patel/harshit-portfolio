            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <div className="max-w-sm mx-auto space-y-6">
                        <a href="mailto:work.harshitpatel@gmail.com" className="flex items-center justify-center space-x-3 p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
                            <FiMail className="w-6 h-6 text-primary-500" />
                            <span className="font-semibold text-gray-700">work.harshitpatel@gmail.com</span>
                        </a>
                        <a href="tel:+916386226495" className="flex items-center justify-center space-x-3 p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
                            <FiPhone className="w-6 h-6 text-primary-500" />
                            <span className="font-semibold text-gray-700">+91 6386226495</span>
                        </a>
                    </div>
