                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    >
                        ...
                        <div className="flex flex-wrap gap-4">
                             ...
                             <a href="/PathByte-CaseStudyReport.pdf" target="_blank" rel="noopener noreferrer" className="inline-flex items-center space-x-2 text-gray-700 bg-gray-200 hover:bg-gray-300 px-6 py-3 rounded-full font-semibold transition-colors">
                                <FiEye />
